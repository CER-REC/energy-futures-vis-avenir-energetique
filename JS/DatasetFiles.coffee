...
DatasetFiles =
  ...
  oct2018:
    ...
    oilProduction: path.join ApplicationRoot, csvDir, '2018-10-30_CrudeOilProduction.csv'
    electricityGeneration: path.join ApplicationRoot, csvDir, '2018-10-26_ElectricityGeneration.csv'
