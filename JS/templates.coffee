module.exports = 
  ...
  bottomNavBarTemplate: """
    ...
    <div class="rightItem" id="dataDownloadLinkAnchor">  
      <a id='dataDownloadLink' data-ajax="false" download='2016-10-26_CanadasEnergyFutureVisualizationData.zip' href='CSV/2016-10-26_CanadasEnergyFutureVisualizationData.zip'>
        {{ dataDownloadLink }}
      </a>
    </div>
